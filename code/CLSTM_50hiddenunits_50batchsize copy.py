...
from clstm3m_Keras import CachedLSTM3m
...
def create_model():
    ...
    lstm = Bidirectional(CachedLSTM3m(50, return_sequences=True, kernel_regularizer=regularizers.l2(0.001)))(embedded_sequences)
    ...
    l_lstm_sent = Bidirectional(CachedLSTM3m(50, return_sequences=True, kernel_regularizer=regularizers.l2(0.001)))))(review_encoder)
